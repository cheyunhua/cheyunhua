<template>
  <div class="page-field">
    ...
    <div class="line"></div>
    <div class="line"></div>
    <div style="width:100%;text-align:center;background-color:#fff;padding:2rem;" id="zhifushibai">
      <i class="icon iconfont icon-zhifushibai" style="color:#FF3900;font-size:8rem;"></i>
      <br>
      <span style="font-size:3rem;">支付失败</span>
    </div>
    <div class="line"></div>
